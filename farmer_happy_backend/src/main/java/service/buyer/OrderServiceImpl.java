...
public class OrderServiceImpl implements OrderService {
    ...
    private void validateCreateOrderRequest(CreateOrderRequestDTO request) throws Exception {
        ...
        if (request.getBuyerAddress() == null || request.getBuyerAddress().length() < 5 || request.getBuyerAddress().length() > 200) {
            Map<String, String> error = new HashMap<>();
    ...
    private void validateRefundRequest(RefundRequestDTO request) throws Exception {
        ...
        if (request.getRefundType() == null || (!request.getRefundType().equals("only_refund") && !request.getRefundType().equals("return_and_refund"))) {
            Map<String, String> error = new HashMap<>();
